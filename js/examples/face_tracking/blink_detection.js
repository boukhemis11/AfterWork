...
function incrementTimer() {
  ...
  const numOfMilliSeconds = timerTime % 100;
  const numOfSeconds = Math.floor((timerTime / 100) % 60);
  const numOfMinutes = Math.floor(timerTime / 6000);

  milliSeconds.innerText = pad(numOfMilliSeconds);
